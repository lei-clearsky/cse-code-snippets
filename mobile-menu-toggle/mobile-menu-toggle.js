var mobileMenuToggle = (function($) {
	...
	var initToggle = function() {
		...
		searchIcon.on(eventType, function(e) {
			e.stopPropagation();
			e.preventDefault();
			if(searchBar.hasClass("searchTopDisplay")) {
				searchBar.removeClass("searchTopDisplay");
			}else{
				searchBar.addClass("searchTopDisplay");
			}
		});


		cseMenuTrigger.on(eventType, function(e) {
			e.stopPropagation();
			e.preventDefault();
